...
[
  {
    ...
    "options": ["Carrot", "Apple", "Banana", "Spinach"],
    "correct": [1, 2]
  },
  {
...
// GitHub Deployment:
// 1. Create a GitHub repo and push the React app code.
// 2. Run: npm install && npm run build
// 3. Deploy via GitHub Pages or Vite's GitHub pages integration
// 4. Use localStorage or a backend to persist data if needed
